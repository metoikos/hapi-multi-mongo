...
exports.register = (server, options, next) => {
    ...
    const makeConnectionObject = function (conf, opts) {
        ...
        // merge connections options with global options,
        // local ones write over global ones
        // first we are copying global opts, otherwise Object.assign changes global options
        connObj.options = Object.assign(Object.assign({}, opts), connObj.options);
    ...
    Promise.map(uris, (uri) => {
        ...
        if (!connectionObj.hasOwnProperty('name')) {
            ...
            if (!uriMatch[uriMatch.length - 1]) {
                throw Error('You have to provide a name for uri or have to connect to directly to specific database.');
            }
